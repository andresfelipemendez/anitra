...
layout(location = 2) in vec2 in_other_pos;
...
void main() {
    ...
    vec4 clip_a = vp * vec4(in_pos, 0.0, 1.0);
    vec4 clip_b = vp * vec4(in_other_pos, 0.0, 1.0);
    ...
    vec2 offset = perp * in_side * line_width * 0.5 / (screen_size * 0.5);
